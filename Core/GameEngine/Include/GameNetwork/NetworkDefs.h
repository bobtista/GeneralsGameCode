...
enum NetCommandType CPP_11(: Int) {
	...
	NETCOMMANDTYPE_RECOVERYREADY,
	NETCOMMANDTYPE_REJOINREQUEST,
	NETCOMMANDTYPE_REJOINROSTER,
};
...
enum RecoveryTuning CPP_11(: Int) {
	...
	RECOVERY_READY_RESEND_MS = 3000,			///< Cadence of repeating the post-load report to peers that have not answered it

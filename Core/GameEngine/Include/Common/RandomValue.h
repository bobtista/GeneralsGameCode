...
// TheSuperHackers @bugfix bobtista 03/09/2026 Logic modules draw from the client generator, so a
// checkpoint must carry its state too or the resumed simulation drifts hundreds of frames later.

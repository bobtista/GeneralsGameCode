...
public:
	...
	DynamicAudioEventRTS(const AsciiString& eventName)
	  : AudioEventRTS(eventName)
	{}
	DynamicAudioEventRTS(const AsciiString& eventName, ObjectID ownerID)
	  : AudioEventRTS(eventName, ownerID)
	{}
	DynamicAudioEventRTS(const AsciiString& eventName, DrawableID drawableID)
	  : AudioEventRTS(eventName, drawableID)
	{}
	DynamicAudioEventRTS(const AsciiString& eventName, const Coord3D* positionOfAudio)
	  : AudioEventRTS(eventName, positionOfAudio)
	{}

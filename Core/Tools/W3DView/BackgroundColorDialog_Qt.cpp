...
CBackgroundColorDialog::CBackgroundColorDialog(QWidget* parent) :
	QDialog(parent),
	m_red(0.0f),
	m_green(0.0f),
	m_blue(0.0f)
{
	setWindowTitle("Background Color");
	resize(250, 150);
	...
	connect(okButton, &QPushButton::clicked, this, &CBackgroundColorDialog::accept);
	connect(cancelButton, &QPushButton::clicked, this, &CBackgroundColorDialog::reject);
}

CBackgroundColorDialog::~CBackgroundColorDialog()
{
}

void CBackgroundColorDialog::accept()
{

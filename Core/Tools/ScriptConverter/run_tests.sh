...
# Find converter executable (built as target z_scriptconverter, output name scriptconverter)
if [ -n "$1" ]; then
    CONVERTER="$1"
elif [ -f "$PROJECT_ROOT/build/win32-debug/GeneralsMD/Code/Tools/ScriptConverter/Debug/scriptconverter.exe" ]; then
    CONVERTER="$PROJECT_ROOT/build/win32-debug/GeneralsMD/Code/Tools/ScriptConverter/Debug/scriptconverter.exe"
elif [ -f "$PROJECT_ROOT/build/win32/GeneralsMD/Code/Tools/ScriptConverter/Release/scriptconverter.exe" ]; then
    CONVERTER="$PROJECT_ROOT/build/win32/GeneralsMD/Code/Tools/ScriptConverter/Release/scriptconverter.exe"
else
    echo "ERROR: Cannot find scriptconverter.exe"

...
{
	if (WWMath::Fabsf_Legacy(point.X - box.Center.X) > box.Extent.X)
		return POS;
	if (WWMath::Fabsf_Legacy(point.Y - box.Center.Y) > box.Extent.Y)
		return POS;
	if (WWMath::Fabsf_Legacy(point.Z - box.Center.Z) > box.Extent.Z)
		return POS;
...
WWINLINE CollisionMath::OverlapType CollisionMath::Overlap_Test(const AABoxClass& box, const AABoxClass& box2)
{
	...
	if (box.Extent.X + box2.Extent.X < WWMath::Fabsf_Legacy(dc.X))
		return POS;
	if (box.Extent.Y + box2.Extent.Y < WWMath::Fabsf_Legacy(dc.Y))
		return POS;
	if (box.Extent.Z + box2.Extent.Z < WWMath::Fabsf_Legacy(dc.Z))
		return POS;

...
#define GGC_RUNTIME_FLAG_LIST(X) \
	...
	X(GgcFlag_NoFocus, "GGC_NO_FOCUS", NULL, GgcTier_Harness, GgcFlagType_Truthy, 0, 0.0f, "keep the window from activating on launch so automated runs do not steal focus") \

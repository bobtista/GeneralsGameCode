...
| 3 | Port rendering subsystems to use the interface, in order of isolation: 2D UI, debug geometry, heat haze, static meshes, terrain, shadows, water, particles. **Scope revision**: this phase is now a pure decoupling pass (no backend runtime changes). Filling in real backend implementations is deferred to Phase 4 because of the DX8 swapchain ownership problem — see [PHASE3.md](PHASE3.md) for details. | **13 subsystems done** (10 fully + 3 partially: 5 in Phase 3, 3 + blend extension in Phase 3B, W3DShroud + SurfaceClass refactor in Phase 3C, W3DMouse + cursor extension in Phase 3D, W3DVolumetricShadow + W3DProjectedShadow partial + alpha-blend extension in Phase 3E, W3DScene partial + stencil state extension in Phase 3F on `bobtista/refactor/phase3f-scene`, see [PHASE3.md](PHASE3.md) / [PHASE3B.md](PHASE3B.md) / [PHASE3C.md](PHASE3C.md) / [PHASE3D.md](PHASE3D.md) / [PHASE3E.md](PHASE3E.md) / [PHASE3F.md](PHASE3F.md)) |

...
{
	if (shader.Get_NPatch_Enable()==ShaderClass::NPATCH_ENABLE && WW3D::Get_Render_Backend() && WW3D::Get_Render_Backend()->Supports_NPatches()) {
...
void Debug_Statistics::Begin_Statistics()
{
	...
	if (WW3D::Get_Render_Backend() != nullptr)
		WW3D::Get_Render_Backend()->Begin_Device_Statistics();
}
...
void Debug_Statistics::End_Statistics()
{
	...
	if (WW3D::Get_Render_Backend() != nullptr)
		WW3D::Get_Render_Backend()->End_Device_Statistics();
}

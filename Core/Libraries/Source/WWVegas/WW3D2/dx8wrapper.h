...
#include "WW3D2/RenderStateCache.h"
#include "WW3D2/FixedFunctionState.h"
...
#  define GGC_RB_DEPRECATED __declspec(deprecated("migrate to WW3D::Get_Render_Backend() equivalent"))
#else

...
)
{
	...
	*/
	...
	if (rtarget != nullptr)
	{
		...
		*/
		WW3D::Get_Render_Backend()->Set_Render_Target_With_Z(rtarget, ztarget);
		...
		*/
		...
		// WW3D::Get_Render_Backend() so the bgfx renderToTexture flag is reset and later draws are not

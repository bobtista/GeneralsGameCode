...
// TheSuperHackers @refactor bobtista 10/04/2026 DX8Backend adapter and
// lifecycle owner. Backend construction and destruction own the DX8Wrapper
// lifecycle. Every rendering method in this file is a one-line trampoline to
// the existing DX8Wrapper static API. Keep it that way — if behavior needs to
// change it should change in DX8Wrapper, not here.
...
// -- Frame lifecycle ---------------------------------------------------------
//
// TheSuperHackers @refactor bobtista 11/04/2026 The WW3D::Get_Render_Backend() Begin/End_Scene pair is

...
#include "dx8caps.h"
#include "WW3D2/dx8formatconv.h"
#include "WW3D2/TextureResourceManager.h"
...
void DX8Wrapper::Do_Onetime_Device_Dependent_Inits()
{
	...
	*/
	...
	// lock classes, whose destructors call WW3D::Get_Render_Backend()->Capture_*
	...
	if (WW3D::Get_Render_Backend() != nullptr)
	{
		...
		WW3D::Get_Render_Backend()->Initialize(_GameHwndForBgfx, ResolutionWidth, ResolutionHeight);
#else
	...
	unsigned short vertex_count)
{
	...
	if (WW3D::Get_Render_Backend() != nullptr) {
		WW3D::Get_Render_Backend()->Submit_Sorted_Draw(dyn_vb_access, dyn_ib_access,

...
void TextureFilterClass::Apply(unsigned int stage)
{
	...
	WW3D::Get_Render_Backend()->Set_Texture_Address_Mode(
		stage,
...
void TextureFilterClass::_Init_Filters(TextureFilterMode texture_filter, AnisotropicFilterMode anisotropy_level)
{
	...
	case TEXTURE_FILTER_BILINEAR:
		...
		FilterSupported = WW3D::Get_Render_Backend() &&
			WW3D::Get_Render_Backend()->Supports_Texture_Filter(RB_TEXTURE_FILTER_MIN_LINEAR) &&
			WW3D::Get_Render_Backend()->Supports_Texture_Filter(RB_TEXTURE_FILTER_MAG_LINEAR);
	...
	case TEXTURE_FILTER_TRILINEAR:
		...
		if (WW3D::Get_Render_Backend() && WW3D::Get_Render_Backend()->Supports_Texture_Filter(RB_TEXTURE_FILTER_MIP_LINEAR)) {
			_MipMapFilters[0][FILTER_TYPE_BEST]=RB_TEXTURE_SAMPLE_LINEAR;
		}
		else {
	...
	case TEXTURE_FILTER_ANISOTROPIC:
		...
		FilterSupported = WW3D::Get_Render_Backend() &&
			WW3D::Get_Render_Backend()->Supports_Texture_Filter(RB_TEXTURE_FILTER_MAG_ANISOTROPIC) &&
			WW3D::Get_Render_Backend()->Supports_Texture_Filter(RB_TEXTURE_FILTER_MIN_ANISOTROPIC);

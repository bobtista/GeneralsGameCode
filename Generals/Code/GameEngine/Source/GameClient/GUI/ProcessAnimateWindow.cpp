...
void ProcessAnimateWindowSlideFromRight::initReverseAnimateWindow( wnd::AnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a nullptr... bad bad bad!"));
		return;
	}
...
void ProcessAnimateWindowSlideFromRight::initAnimateWindow( wnd::AnimateWindow *animWin )
{
	...
	if(!win)
	{
		DEBUG_ASSERTCRASH( win, ("animWin contains a nullptr for it's GameWindow... Whatup wit dat?"));
		return;
	}
...
Bool ProcessAnimateWindowSlideFromRight::updateAnimateWindow( wnd::AnimateWindow *animWin )
{
	...
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into updateAnimateWindow as a nullptr... bad bad bad!"));
		return TRUE;
	}

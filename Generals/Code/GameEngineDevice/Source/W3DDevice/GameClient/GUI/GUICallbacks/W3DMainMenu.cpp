...
//	static IRegion2D	vertical5 ={pos.x + (size.x * .7250), pos.y + (size.y * .12), pos.x + (size.x * .7250), pos.y + (size.y * .86) 	};
//	static IRegion2D	vertical6 ={pos.x + (size.x * .9062), pos.y + (size.y * .12), pos.x + (size.x * .9062), pos.y + (size.y * .86) 	};
...
//	TheDisplay->drawLine(vertical5.lo.x,vertical5.lo.y,vertical5.hi.x,vertical5.hi.y,3,color);
//	TheDisplay->drawLine(vertical6.lo.x,vertical6.lo.y,vertical6.hi.x,vertical6.hi.y,3,color);

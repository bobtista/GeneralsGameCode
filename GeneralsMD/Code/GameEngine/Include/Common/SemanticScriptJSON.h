...
// TheSuperHackers @feature bobtista 29/06/2026 Semantic JSON serialization for scripts
...
// Parameters are an ordered array of single-key {label: value} objects, matched by position
// on read (the label is cosmetic), so renamed UI strings or duplicate labels never break a roundtrip.
// Format example:
// {
//   "version": 1,
//   "players": [
...
//         "isActive": true,
//         "if": [
//           [ { "conditionTrue": [] } ]   // OR clauses, each an array of AND conditions
//         ],
//         "then": [

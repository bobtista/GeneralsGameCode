...
{
	// TheSuperHackers @bugfix bobtista 30/08/2026 Do not place mines while a save is loading. Team
	// wiring during load re-evaluated the upgrades and added a duplicate set of mines.
...
/** Xfer method
	* Version Info:
	* 1: Initial version
	* 2: TheSuperHackers @bugfix bobtista 21/08/2026 Extend UpdateModule instead of BehaviorModule so
	*    the sleepy wake frame survives the save. A load woke the module and reordered updates. */
// ------------------------------------------------------------------------------------------------

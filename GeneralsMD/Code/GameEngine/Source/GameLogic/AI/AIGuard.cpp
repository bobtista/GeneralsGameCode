...
// inner -> outer -> crate -> return without ever settling. Report a movement failure as success
// instead, so the owner idles where it is and retries on the idle scan interval.

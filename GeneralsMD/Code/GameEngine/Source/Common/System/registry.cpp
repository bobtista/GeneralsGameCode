...
// Adapted from fbraz3/GeneralsX (felipebraz, GitHubCopilot). Persisted reads
...
// language selection. Adapted from GeneralsX (felipebraz 18/02/2026,
// GitHubCopilot 16/03/2026).

	...
	unsigned short vertex_count)
{
	...
	state->transformed_center = Transform_Sorted_Point(state->bounding_sphere.Center, mtx);
...
*/
	...
	DynamicIBAccessClass dyn_ib_access(BUFFER_TYPE_DYNAMIC,polygonAllocCount*3);
	{
